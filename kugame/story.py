...
class StoryChapter:
    ...
    Attributes:
        ...
        commands_to_learn: 本章节要学习的命令
        challenge_id: 挑战ID
        reward_exp: 完成奖励经验
        characters: 出场人物列表
        events: 章节事件列表
        boss_fight: 是否有 boss 战
    """
    chapter_id: Chapter
    title: str
    introduction: str
...
class StoryManager:
    ...
    def _initialize_random_events(self) -> List[StoryEvent]:
        ...
        return [
            StoryEvent(
                ...
                consequences=[
                    "你打开了宝箱，发现了一本修炼秘籍！获得了100经验值！",
                    "你将宝箱上报宗门，掌门真人赞赏你的诚实，奖励你50经验值！",
                    "你决定不惹麻烦，离开了此地。"
                ],
                required_level=1,
                rewards={
    ...
    def _initialize_chapters(self) -> Dict[Chapter, StoryChapter]:
        ...
        return {
            Chapter.序章: StoryChapter(
                ...
                老者微微一笑："要想踏入仙境，需先学会'容器化'之术。此术可将万物装入方寸之间，
            ...
            Chapter.第二章: StoryChapter(
                ...
                大师兄解释道："这便需要'Service'之术。Service是容器的门徒，
            ...
            Chapter.第三章: StoryChapter(
                ...
                岂不劳民伤财？今日本座传授你'ConfigMap'和'Secret'之术。"
            ...
            Chapter.第四章: StoryChapter(
                ...
                "这便是'PersistentVolume'之术，数据如同宗门典籍，需永久保存，不可或缺。
                ...
                有了此术，你的应用便拥有了'记忆'，不再担心数据丢失。"
                """,
                kubernetes_concepts=["PersistentVolume", "PersistentVolumeClaim", "存储类", "数据持久化"],
            ...
            Chapter.第五章: StoryChapter(
                ...
                reward_exp=500,
                characters=[self.characters["神秘人"]],
                events=[],
                boss_fight=False
            ),
            ...
            Chapter.第八章: StoryChapter(
                ...
                善用此术，可使宗门固若金汤，万无一失。"
                """,
                kubernetes_concepts=["网络策略", "RBAC权限", "Secret管理", "安全最佳实践"],
            ...
            Chapter.第九章: StoryChapter(
                chapter_id=Chapter.第九章,
                title="集群管理",
            ...
            Chapter.终章: StoryChapter(
                ...
                ╚═══════════════════════════════════════════════════════╝
                """,
                kubernetes_concepts=["Kubernetes全貌", "最佳实践", "持续学习"],
                commands_to_learn=["kubectl completion", "kubectl plugin list"],
                challenge_id="final_challenge",
                reward_exp=1000,
                characters=[self.characters["掌门真人"], self.characters["大师兄"], self.characters["二师兄"], self.characters["三师姐"], self.characters["四师妹"]],
                events=[],
                boss_fight=False
            ),
        }
    ...
    def get_completed_chapters(self, player: Player) -> int:
        ...
        chapter_challenge_map = {
            ...
            Chapter.第一章: "chapter_1_challenge",
            Chapter.第二章: "chapter_2_challenge",
            Chapter.第三章: "chapter_3_challenge",
            Chapter.第四章: "chapter_4_challenge",
            Chapter.第五章: "chapter_5_challenge",
            Chapter.第六章: "chapter_6_challenge",
            Chapter.第七章: "chapter_7_challenge",
            Chapter.第八章: "chapter_8_challenge",
            Chapter.第九章: "chapter_9_challenge",
